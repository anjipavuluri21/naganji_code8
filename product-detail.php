...
<?php } ?>
                            <div class="carousel-main" id="sizeSection">
                                <p><a href="javascript:void(0);" class="size-heading">SIZE</a></p>
                                <div class="size-alert"><span class="alert-danger"><strong>!</strong> Please select a size</span></div>
...
<?php } ?>
                            ...
                            <div class="carousel-main">
                                <p class="font-size-15">Color</p>
                                <div class="color-alert"><span class="alert-danger"><strong>!</strong> Please select a color</span></div>
...
<?php } ?>														
                            ...
                            <div class="carousel-main">
                                <p class="font-size-15">Quantity</p>
                            ...
                            <div class="addtocart-detail">
                                <div class="addtocart-div mb-3">							
                                    <button <?php /* if($totstockqty==0){ ?> disabled <?php } onclick="return checkValidation();" */ ?> class="button"  value="Add to Cart"  type="submit" name="submitaddtocart">Add to Cart</button>
...
<?php echo $help_res['content']; ?>
                                    ...
                                    <li><a href="#storeModal" data-fancybox data-animation-duration="700" class="find-in-store-btn">Find In Store<span></span></a></li>
                                </ul>
                            </div>	
                        </form>
                    </div>
...
<div id="prodcombnotavail" class="popup-hidden animated-modal added-cart-model prodcombnotavail">
    <p class="anim1"><strong>Product combination is not available in Stock!</strong></p>
