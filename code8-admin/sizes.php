    ...
    <link href="vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css" rel="stylesheet">
        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<a align="right" href="size_addnew.php"><button class="btn btn-success"><i class="fa fa-plus"></i> Add New Size</button></a>	
            <div class="clearfix"></div>
            <div class="row">             
             <div class="clearfix"></div>
                      ...
                      <table id="datatable" class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">                            
							...
							<th width="300" class="column-title">Size</th>
						...
						<?php
						$i = 1;						
						$banner_que = "SELECT * from code8_sizes where 1=1 ORDER BY id DESC";
						...
						?>
                          <tr class="even pointer">                            
							...
							<a class="btn btn-info" href="size_edit.php?id=<?php echo $banner_result['id'] ?>">Edit</a>&nbsp;
...
$(function(){
	$("[id^='delete_']").click(function(){
     	var i=$(this).attr('id');		
			...
			type:"POST",
			data:"id="+i,
			url:"deletecollection.php?type=size",
...
$(function(){
	$("[id^='status_']").click(function(){
		...
		var j=arr2[1];
			...
			type:"POST",
			data:"id="+i+"&"+j,
			url:"changestatus.php?type=size",
			success:function(data)
			{
				if(data=="done")
				{
