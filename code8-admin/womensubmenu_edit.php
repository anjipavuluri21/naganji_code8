...
{	
	...
	$login_query = "UPDATE code8_womensubmenu SET menuid='$menuid', title='$title', titlear='$titlear' WHERE id=$id";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Edit Women SubMenu</h3>
              </div>
            </div>
			<?php
				$banner_que = "SELECT * from code8_womensubmenu where id=$id";
