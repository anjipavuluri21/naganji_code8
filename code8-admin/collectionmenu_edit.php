...
{	
	...
	$login_query = "UPDATE code8_collectionsmenu SET title='$title', titlear='$titlear', menutype='$menutype' WHERE id=$id";
	...
	if($res == 1){
		header("location:collectionsmenu.php?msg=success");		
	} else {		
		header("location:collectionsmenu.php?msg=fail");		
	}	
}	
?>
        <!-- page content -->
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Edit Collection Menu</h3>
              </div>
            </div>
			<?php
				$banner_que = "SELECT * from code8_collectionsmenu where id=$id";
					 ...
					 <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="collectionsmenu.php" class="btn btn-primary">Cancel</a>
