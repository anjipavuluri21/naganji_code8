...
{			
	...
	{			
		...
		if (($ext == "jpg") || ($ext == "jpeg") || ($ext == "png")) {
			...
			if (move_uploaded_file($_FILES['image']['tmp_name'], $target_file1)) {	
				$login_query = "UPDATE code8_homepageheader SET title='$title', caption='$caption', titlear='$titlear', captionar='$captionar', image='$blocation1', shopnowlink='$shopnowlink' WHERE id=3";
		...
		$login_query = "UPDATE code8_homepageheader SET title='$title', caption='$caption', titlear='$titlear', captionar='$captionar', shopnowlink='$shopnowlink' WHERE id=3";
		$database1 = new Database();
		$dbCon1 = $database1->getConnection();
		$stmt1 = $dbCon1->prepare($login_query);  
		$stmt1->execute();
	...
	if($res == 1){
		header("location:homepagebody3.php?msg=success");		
	} else {		
		header("location:homepagebody3.php?msg=fail");		
	}	
}	
?>
        <!-- page content -->
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Homepage Body Section 3</h3>
              </div>
			<?php
				$banner_que = "SELECT * from code8_homepageheader where id=3";
				$database1 = new Database();
				$dbCon1 = $database1->getConnection();
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">View more Link<span class="required">*</span>
                        </label>                        
						<div class="col-md-9 col-sm-9 col-xs-12">
