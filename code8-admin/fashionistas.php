	  ...
	  <div class="">
		<div class="page-title">
		  <div class="title_left">
			<h3>Fashionistas</h3><hr>
		  </div>             
		</div>
		<div class="clearfix"></div>			
			<a align="right" href="fashionista_addnew.php"><button class="btn btn-success"><i class="fa fa-plus"></i> Add New Fashionista</button></a>			
		<div class="clearfix"></div>
		<div class="row">           
		  <div class="clearfix"></div>
				  ...
				  <table id="datatable" class="table table-striped jambo_table bulk_action">
					<thead>
					  <tr class="headings">                            
						...
						<th width="300" class="column-title">Fashionista Name</th>			 
					...
					<?php
					$i = 1;
					$banner_que = "SELECT * from code8_fashionistas where 1=1 ORDER BY id DESC";
					...
					?>
					  <tr class="even pointer">                            
						...
						<td class=" "><img src="../<?php echo $banner_result['image'] ?>" height="75" width="75"/></td>
						...
						<a class="btn btn-info" href="fashionista_edit.php?id=<?php echo $banner_result['id'] ?>">Edit</a>&nbsp; 
...
$(function(){
	$("[id^='delete_']").click(function(){
     	var i=$(this).attr('id');		
			...
			type:"POST",
			data:"id="+i,
			url:"deletecollection.php?type=fashionista",
...
$(function(){
	$("[id^='status_']").click(function(){
		...
		var j=arr2[1];
			...
			type:"POST",
			data:"id="+i+"&"+j,
			url:"changestatus.php?type=fashionista",
			success:function(data)
			{
				if(data=="done")
				{
