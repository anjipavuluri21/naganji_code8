...
{			
	...
	$adminmenu_query = "UPDATE code8_stocks SET prodid='$product', warehouseid='$warehouse', size='$size', color='$color', quantity='$quantity' WHERE id=$id";	
	  ...
	  <div class="">
		<div class="page-title">
		  <div class="title_left">
			...
			<?php
				$banner_que = "SELECT * from code8_stocks where id=$id";
				...
				$warehouse = $about_res['warehouseid'];
				$size = $about_res['size'];
				$color = $about_res['color'];							
			?>
		</div>
				...
				<div class="form-group">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						<select name="warehouse" id="warehouse" required class="form-control" style="width: 780px;">
							...
							{
							?>
								<option <?php if($warehouse==$banner_result['id']){ echo "selected"; } ?> value="<?php echo $banner_result['id'] ?>"><?php echo $banner_result['title'] ?></option>								
							<?php } ?>								
						</select>
					</div>
				  </div>
				 <div class="form-group">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">						
						<select name="size" id="size" required class="form-control" style="width: 780px;">
							...
							{
							?>
								<option <?php if($size==$banner_result['id']){ echo "selected"; } ?> value="<?php echo $banner_result['id'] ?>"><?php echo $banner_result['title'] ?></option>								
							<?php } ?>								
						</select>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">						
						<select name="color" id="color" required class="form-control" style="width: 780px;">
							...
							{
							?>
								<option <?php if($color==$banner_result['id']){ echo "selected"; } ?> value="<?php echo $banner_result['id'] ?>"><?php echo $banner_result['title'] ?></option>								
							<?php } ?>								
						</select>
					</div>
				  </div>
				  ...
				  <div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							<input type="number" name="quantity" id="quantity" required="required" value="<?php echo $about_res['quantity'] ?>" class="form-control" style="width: 780px;">
						</div>
                      </div>
