...
{	
	...
	$login_query = "UPDATE code8_sizes SET title='$title' WHERE id=$id";
	...
	if($res == 1){
		header("location:sizes.php?msg=success");		
	} else {		
		header("location:sizes.php?msg=fail");		
	}	
}	
?>
        <!-- page content -->
        <div class="right_col" role="main">
          <div class="">
			...
			<?php
				$banner_que = "SELECT * from code8_sizes where id=$id";
					...
					<div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="sizes.php" class="btn btn-primary">Cancel</a>
