...
<section class="innerpages">
	<div class="container clearfix">
		<div class="row">
			...
			<?php							
			$prod_que = "SELECT * from code8_products where subcat=$id AND status=1 ORDER BY id DESC LIMIT 12";
			...
			<div class="col-lg-3 col-md-3 product-box collecnewin">
				<div class="product-thumb">
					...
					<div class="product-dtl">
						<div class="product-price-btn"><div class="product-price"><?php echo $sprod_price; ?> <?php echo $currencycode; ?></div><!--<div class="favrt-sub"><?php if($_SESSION["SESS_CUSTOMER_ID"]!=""){ ?>	
...
$(document).ready(function(){
    $(document).on('click','.load-more-link',function(){
        ...
        $.ajax({
            type:'POST',
            url:"ajax_more_products.php?mid=<?php echo $id; ?>",
            data:'id='+ID,
...
$(".apply-filter").click(function(){
	...
	$.ajax({
		...
		url:"productsnewinsearch.php?mid=<?php echo $id; ?>",
		success:function(data)
		{				
