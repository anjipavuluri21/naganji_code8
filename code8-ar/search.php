...
<section class="innerpages">
	<div class="container clearfix">
		<div class="row">
			...
			<?php							
			$prod_que = "SELECT * from code8_products where prodtitle like '%$searchkeyword%' AND status=1 ORDER BY id DESC LIMIT 12";
...
$(document).ready(function(){
    $(document).on('click','.load-more-link',function(){
        ...
        $.ajax({
            type:'POST',
            url:"ajax_search_products.php?search=<?php echo $searchkeyword; ?>",
            data:'id='+ID,
