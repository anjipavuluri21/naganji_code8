...
<section class="innerpages">
	<div class="container clearfix">
		<div class="row">
			<div class="col-12">
				<h1><?php echo $fashion_res['namear']; ?></h1>
			</div>
			...
			<div class="col-lg-6 col-md-6 noha-right-column">
				<div class="right-column">
					<h2><?php echo $fashion_res['titlear']; ?></h2>
					<?php echo $fashion_res['descriptionar']; ?>
				</div>
			</div>
			<div class="col-12 relative-main">
				<h3><?php echo $fashion_res['namear']; ?> Products</h3>
			...
			<div class="col-12 discovery-title">
				<a href="<?php echo $fashion_res['collectionlink']; ?>">
					...
					<span><?php echo $fashion_res['collectiontitlear']; ?></span>
				</a>
			</div>
