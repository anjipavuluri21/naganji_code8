...
<section class="innerpages">
	<div class="container clearfix">
		<div class="row">
			...
			<?php							
			$prod_que = "SELECT * from code8_products where menuid=2 AND status=1 ORDER BY id DESC LIMIT 12";
			...
			<div class="col-lg-3 col-md-3 product-box collecnewin">
				<div class="product-thumb">
					...
					<?php } else { ?>
						<a href="javascript:void(0);" class="favrtlog-div wishlist" title="Favourite"><span>WISHLIST <img src="images/favourite.png" alt="Favourite"></span></a>
					<?php } ?></div></div>
			...
			<?php if($rowCount>0){ ?>	
			<div class="col-12 load-more" id="show_more_main<?php echo $prodid; ?>">
				<a id="<?php echo $prodid; ?>" href="javascript:void(0);" class="load-more-link">تحميل المزيد +</a>
			</div>
			<?php }	?>
...
$(document).ready(function(){
    $(document).on('click','.load-more-link',function(){
        ...
        $.ajax({
            type:'POST',
            url:"ajax_more_womens_listing.php?mid=<?php echo $id; ?>",
            data:'id='+ID,
