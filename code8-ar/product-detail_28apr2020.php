...
if(isset($_POST['submit'])){	
	...
	//echo "<script>window.location='product-detail.php?id=$id'</script>";
}
?>
						...
						<div class="product-container swiper-container">
							...
							?>
								<div class="swiper-slide">
									<div class="product-img" data-fancybox="product" data-src="<?php echo $proding_res['image']; ?>"><img src="<?php echo $proding_res['image']; ?>" alt="Product"/></div>
								</div>
							<?php }	?>		
							</div>
						</div>
				...
				<div class="product-detail">
					...
					<input type="hidden" name="ship_price" value="<?php echo $ship_price; ?>">
						...
						<div class="carousel-main">
							...
							<div class="carousel-sub">
								...
								<input type="hidden" name="selsize" id="selsize">
									<div class="swiper-wrapper">
										...
										?>
											<div class="swiper-slide">		
												<a name="size" id="<?php echo $size_result['sizes']; ?>" href="#" class="size-link"><?php echo getSize($size_result['sizes']); ?></a>
											</div>										
										<?php }	?>
									</div>
								</div>
							...
							<div class="size-guide-div"><a href="#sizeModal" data-fancybox class="size-guide-link">Link to دليل المقاسات
</a></div>
						</div>
						<div class="carousel-main">
							<p>Color</p>
						...
						<div class="pricekd-favourite">
							...
							<?php if($_SESSION["SESS_CUSTOMER_ID"]!=""){ ?>	
								<a id="movetowish_<?php echo $id; ?>" href="javascript:void(0);" class="wishlist-link" title="Favourite">WISHLIST <img src="images/12D9CE31.png" alt="Favourite"></a>
							<?php } else { ?>
