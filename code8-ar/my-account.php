	...
	<div class="container clearfix">
		<div class="row" id="ele2">
			<div class="col-lg-12 col-md-12">
				<h1 class="text-center fullwidth">لي <span>الملف الشخصي</span></h1>
			</div>
							...
							<div class="myprofile-main">
								...
								<div class="profileform">
									...
									<div class="change-div">
										<button class="button" name="myaccount" type="submit">تحديث</button>
									<a href="javascript:void(0);" class="button closebutton">أغلق</a></div>
								</div>
								</form>
							</div>
						</div>
