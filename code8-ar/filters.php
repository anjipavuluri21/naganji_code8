...
<div class="col-12 title-sort">
	...
	if($pagename=='search.php'){
		...
		$category_name = "المنتجات في<span>مبيعات</span>";
	} else if($pagename=='womens_newin.php'){
		$category_name = "نساء <span>الجديد في</span>";
	} else if($id!=""){
		$category_name = getCollectionsSubmenu($id);
	} else {
		$category_name = "منتجات <span>الجديد في</span>";
	}
	?>
	<h1><?php echo $category_name; ?></h1>
	<ul class="sorting">
		<li><a href="javascript:void(0);" data-id="1">التصنيف حسب</a></li>
		<li><a href="javascript:void(0);" data-id="2">اللون</a></li>
		<li><a href="javascript:void(0);" data-id="3">المقاس</a></li>
		<li><a href="javascript:void(0);" data-id="4">الموسم</a></li>
	</ul>
