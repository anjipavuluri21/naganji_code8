...
if(isset($_POST["id"]) && !empty($_POST["id"])){
	...
	$prodcount_que = "SELECT COUNT(*) as num_rows from code8_products where subcat=$mid AND id < ".$_POST['id']." AND status=1 ORDER BY id DESC";
	...
	$showLimit = 4;
	//get rows query		
	$remprodcount_que = "SELECT * from code8_products where subcat=$mid AND id < ".$_POST['id']." AND status=1 ORDER BY id DESC LIMIT ".$showLimit;
	$database1 = new Database();
	$dbCon1 = $database1->getConnection();
			...
			<div class="col-lg-3 col-md-3 product-box">
				<div class="product-thumb">
					...
					<div class="product-dtl">
						<div class="product-price-btn"><div class="product-price"><?php echo $sprod_price; ?> <?php echo $currencycode; ?></div>
						<div class="favrt-sub">
					...
					<?php } else { ?>
						<a href="javascript:void(0);" class="favrtlog-div wishlist" title="Favourite">WISHLIST <span><img src="images/favourite.png" alt="Favourite"></span></a>
					<?php } ?></div></div>
				</div><h2><?php echo $prod_result['prodtitle']; ?></h2>
					</div>
		   </div> 		
	<?php } ?>
