...
<section class="innerpages">
	<div class="container clearfix">
		<div class="row">
			...
			<?php							
			$prod_que = "SELECT * from code8_products where brand=$id AND status=1 ORDER BY id DESC LIMIT 12";
...
$(document).ready(function(){
    $(document).on('click','.load-more-link',function(){
        ...
        $.ajax({
            type:'POST',
            url:"ajax_more_brands.php?mid=<?php echo $id; ?>",
            data:'id='+ID,
...
$(".apply-filter").click(function(){
	...
	$.ajax({
		...
		url:"brandsnewinsearch.php?mid=<?php echo $id; ?>",
		success:function(data)
		{				
