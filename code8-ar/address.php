	...
	<div class="container clearfix">
		<div class="row" id="ele2">
			<div class="col-lg-12 col-md-12">
				<h1 class="text-center fullwidth">لي <span>عنوان</span></h1>
			</div>
						...
						<div class="checkout-sub address-sub-div">
							...
							<div class="profiledata">
								<div class="form-group">
									<label>منطقة </label><p><?php echo $myaddrres['ship_area']; ?> </p>
								</div>
								<div class="form-group">
									<label>شارع </label><p><?php echo $myaddrres['ship_street']; ?></p>
								</div>
								<div class="form-group">
									<label>لا للبناء</label><p><?php echo $myaddrres['ship_building']; ?></p>
								</div>
								<div class="form-group">
									<label>رقم الشقة</label><p><?php echo $myaddrres['ship_appartment']; ?></p>
								</div>
								<div class="form-group">
									<label>منع</label><p><?php echo $myaddrres['ship_block']; ?></p>
								</div>
								<div class="form-group">
									<label>السبيل</label><p><?php echo $myaddrres['ship_avenue']; ?></p>
								</div>
								<div class="form-group">
									<label>رقم الطابق</label><p><?php echo $myaddrres['ship_floor']; ?></p>
								</div>						
								<div class="change-div"><a href="javascript:void(0);" class="button change-btn">يتغيرون</a></div>
							</div>					
...
<div class="same-as"><ul class="unstyled">
								<li>
									...
									<label for="p_address"><span>مثل عنوان الشحن
</span></label>
								</li>
							</ul></div></h3>
							<form name="" method="post" action="profileupdate.php">
							...
							<div class="profiledata">
								<div class="form-group">
									<label>منطقة </label><p><?php echo $myaddrres['bill_area']; ?> </p>
								</div>
								<div class="form-group">
									<label>شارع </label><p><?php echo $myaddrres['bill_street']; ?></p>
								</div>
								<div class="form-group">
									<label>لا للبناء</label><p><?php echo $myaddrres['bill_building']; ?></p>
								</div>
								<div class="form-group">
									<label>رقم الشقة</label><p><?php echo $myaddrres['bill_appartment']; ?></p>
								</div>
								<div class="form-group">
									<label>منع</label><p><?php echo $myaddrres['bill_block']; ?></p>
								</div>
								<div class="form-group">
									<label>السبيل</label><p><?php echo $myaddrres['bill_avenue']; ?></p>
								</div>
								<div class="form-group">
									<label>رقم الطابق</label><p><?php echo $myaddrres['bill_floor']; ?></p>
								</div>
