...
if(isset($_POST["id"]) && !empty($_POST["id"])){
	...
	$prodcount_que = "SELECT COUNT(*) as num_rows from code8_products where id < ".$_POST['id']." AND status=1 AND sale=1 ORDER BY id ASC";
	...
	$showLimit = 4;
	//get rows query		
	$remprodcount_que = "SELECT * from code8_products where id > ".$_POST['id']." AND status=1 AND sale=1 ORDER BY id ASC LIMIT ".$showLimit;
	$database1 = new Database();
	$dbCon1 = $database1->getConnection();
