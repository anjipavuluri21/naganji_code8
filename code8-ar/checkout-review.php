	...
	<div class="container clearfix">
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<h1 class="text-center fullwidth">طلب <span>مراجعة</span></h1>
			</div>
			<div class="col-lg-6 col-md-6 mycart-column">
				<div class="my-cart-items">
						...
						<div class="checkout-sub address-sub-div">
							...
							<div class="profiledata">
								<div class="form-group">
									<label>الاسم الكامل</label><p><?php echo $custinfo['fullname']; ?></p>
								</div>
								<div class="form-group">
									<label>البريد الإلكتروني</label><p><?php echo $custinfo['email']; ?></p>
								</div>
								<div class="form-group">
									<label>التليفون المحمول</label><p><?php echo $custinfo['mobile']; ?></p>
								</div>
								<div class="form-group">
									<label>العنوان 1</label><p><?php echo $myaddrres['address1']; ?></p>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label>المدينة</label><p><?php echo ($myaddrres['towncity']); ?></p>
								</div>
								<div class="form-group">
									<label>الولاي</label><p><?php echo ($myaddrres['statecounty']); ?></p>
								</div>
								<div class="form-group">
									<label>البلد</label><p><?php echo getShipCountry($myaddrres['country']); ?></p>
								</div>
								<div class="form-group">
									<label>الرمز البريدي</label><p><?php echo $myaddrres['postalzip']; ?></p>
								</div>							
								<div class="change-div"><a href="javascript:void(0);" class="button change-btn">تغيير</a></div>
							</div>					
					...
					<!--<div class="form-group">
						...
						<div class="checkout-sub address-sub-div">
							<h3>عنوان الدفع
<div class="same-as"><ul class="unstyled">
								<li>
									...
									<label for="p_address"><span>Same As عنوان الشحن
</span></label>
								</li>
							</ul></div></h3>
							<form name="" method="post" action="">
							...
							<div class="profiledata">
								<div class="form-group">
									<label>العنوان 1</label><p><?php echo $myaddrres['baddress1']; ?></p>
								</div>
								<div class="form-group">
									<label>العنوان 2</label><p><?php echo $myaddrres['baddress2']; ?></p>
								</div>
								<div class="form-group">
									<label>المدينة</label><p><?php echo ($myaddrres['btowncity']); ?></p>
								</div>
								<div class="form-group">
									<label>الولاية</label><p><?php echo ($myaddrres['bstatecounty']); ?></p>
								</div>
								<div class="form-group">
									<label>البلد</label><p><?php echo getShipCountry($myaddrres['bcountry']); ?></p>
								</div>
								<div class="form-group">
									<label>الرمز البريدي</label><p><?php echo $myaddrres['bpostalzip']; ?></p>
								</div>	
								<div class="change-div"><a href="javascript:void(0);" class="button change-btn">تغيير</a></div>
							</div>					
							<div class="profileform">
								...
								<div class="product-th-right">
									<div class="product-dtl">	
										...
										<div class="size-color-name">
											<div class="size-s">المقاس : <?php echo getSize($sizeid); ?></div>
											<div class="color-name">اللون : <?php echo getColor($colorid); ?></div>
											<div class="qty-num">الكمية : <?php echo ($cartprod_result['quantity']); ?></div>
										</div>
									</div>
								</div>
							</div>	
...
<!--								<li class="white">
							...
							<div class="order-div">
							<!--<a href="k-net.php" class="button fullwidth" onclick="return validateAddr()">ادفع الآن
</a>-->
						...
						<?php } else { ?>
							<div class="order-div"><a href="#" class="button fullwidth emptycart">ادفع الآن
</a></div>
						<?php } ?>
				</div>
			</div>
...
<div id="shippingaddress" class="popup-hidden animated-modal added-cart-model shippingaddress">
	<p class="anim1"><strong>Please fill عنوان الشحن
!</strong></p>
...
<div id="billingaddress" class="popup-hidden animated-modal added-cart-model billingaddress">
	<p class="anim1"><strong>Please fill عنوان الدفع
!</strong></p>
	<p class="anim2"><a href="javascript:void(0);" onclick="$.fancybox.close();" class="button">OK</a></p>
</div>
