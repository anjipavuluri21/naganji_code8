		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-12">
				<div class="address-main">
					<?php echo $footercont_res['addressar']; ?>
			...
			<div class="col-12 copyrights"><p><span class="years-at">© <?php echo date('Y'); ?></span> <span class="pipe"></span> <a href="javascript:void(0);" class="privacy">سياسة الخصوصية </a></p></div>
		</div>
	</div>	
</footer>
	...
	<div class="shoppingcart-popup-sub">
						...
						<div class="product-th-right">
							<div class="product-dtl">							
								...
								<div class="size-color-name">
									<div class="size-s">المقاس :<?php echo getSize($cartprod_result['size']); ?></div>
									<div class="color-name">اللون : <?php echo getColor($cartprod_result['color']); ?></div>
									<div class="color-name">الكمية : <?php echo ($cartprod_result['quantity']); ?></div>
								</div>
		...
		<div class="row cart-order">
			<div class="col-lg-12 col-md-12">
				<div class="total-table">مجموع : <?php echo number_format($subtotal,3); ?> <?php echo $currencycode; ?></div>
			</div>
			<?php if($subtotal!=0){ ?>
				<!--<div class="col-lg-6 col-md-6"><a href="my-cart.php" class="button">See My Carts</a></div>-->
				<?php if($loginid!=""){ ?>
					<?php if($_SESSION["SESS_CUSTOMER_TYPE"]==1){ ?>
						<div class="col-lg-6 col-md-6"><a href="checkout-review.php" class="button">تنفيذ الطلب</a></div>
					<?php } else { ?>
						<div class="col-lg-6 col-md-6"><a href="order-review.php" class="button">تنفيذ الطلب</a></div>
					<?php } ?>
					
				<?php } else { ?>
					<div class="col-lg-6 col-md-6"><a href="my-cart.php" class="button">تنفيذ الطلب</a></div>
				<?php } ?>
			<?php } else { ?>
				<div class="col-lg-6 col-md-6"><a href="#" data-src="#emptycart" data-fancybox=""  class="button emptycart">عرض عربة التسوق الخاصة بي</a></div>
				<div class="col-lg-6 col-md-6"><a href="#" data-src="#emptycart" data-fancybox="" class="button emptycart">تنفيذ الطلب</a></div>
			<?php } ?>
		</div>
	</div>
</div>
<div id="loginModal" class="popup-hidden animated-modal">
	<form name="signin" method="post" action="" autocomplete="off">	
		<h2 class="anim1">تسجيل الدخول</h2>
		...
		<div class="form-group anim5">
			<button type="submit" name="login" class="button">تسجيل الدخول</button>
			<a href="javascript:void(0);" class="forgot-link">نسيت كلمة المرور</a>
		</div>
		</form>
		...
		<div class="forgot-main">
			<div class="form-group">
				<div class="forgot-div">
					...
					<button type="submit" name="forgot" class="button">إعادة تعيين كلمة المرور</button>
				</div>
			</div>
		</div>
		</form>
    <p class="forgot-reg anim6"> ليس لديك حساب؟<a href="javascript:void(0);" onclick="$.fancybox.close();" data-fancybox data-src="#signupModal" data-animation-duration="700">&nbsp;تسجيل</a></p>	
</div>

<div id="signupModal" class="popup-hidden animated-modal">
	<form name="register" action="" method="post" autocomplete="off">	    
		<h2 class="anim1">التسجيل</h2>
		<div class="form-group anim2">
		...
		<div class="form-group anim5 signup-btn">
			<button type="submit" name="register" class="button">التسجيل</button> 
			<p class="forgot-reg">عضو بالفعل؟ <a href="javascript:void(0);" onclick="$.fancybox.close();" data-fancybox data-src="#loginModal" data-animation-duration="700">تسجيل الدخول</a></p>
		</div>
	</form>
</div>
<div id="storeModal" class="popup-hidden animated-modal">
	<h2 class="anim1">متاجرنا</h2>
	<div class="form-group anim2">
	...
	<div class="anim4 signup-btn"><a href="find-our-store.php" class="button">ابحث عن المتجر</a></div>
</div>	
<div id="sizeModal" class="popup-hidden size-guide animated-modal">
	<p class="anim1">دليل المقاسات</p>
	<h4 class="anim2">معاطف خارجية<br>قياسات</h4>
...
<div id="addedCartModel" class="popup-hidden animated-modal added-cart-model">
	<p class="anim1"><strong>تمت إضافة المنتج إلى عربة التسوق !!!</strong></p>
...
<div id="wishlistlogpop" class="popup-hidden animated-modal added-cart-model">
	<p class="anim1"><strong>الرجاء تسجيل الدخول لإضافة منتجات إلى قائمة الرغبات!!</strong></p>
	<p class="anim2"><a href="javascript:void(0);" onclick="$.fancybox.close();" class="button">OK</a></p>
</div>

<div id="emptycart" class="popup-hidden animated-modal added-cart-model">
	<p class="anim1"><strong>العربة فارغة!!</strong></p>
	<p class="anim2"><a href="javascript:void(0);" onclick="$.fancybox.close();" class="button">OK</a></p>
</div>

<div id="notloggedinpop" class="popup-hidden animated-modal added-cart-model notloggedinpop">
	<p class="anim1"><strong>تم تحديث عربة التسوق بنجاح. الرجاء تسجيل الدخول / التسجيل لمتابعة التسوق</strong></p>
	<p class="anim2"><a href="javascript:void(0);" onclick="$.fancybox.close();" class="button">OK</a></p>
</div>
