...
if(isset($_POST["id"]) && !empty($_POST["id"])){
	...
	$prodcount_que = "SELECT COUNT(*) as num_rows from code8_products where brand=$mid AND id < ".$_POST['id']." AND status=1 ORDER BY id DESC";
	...
	$showLimit = 4;
	//get rows query		
	$remprodcount_que = "SELECT * from code8_products where brand=$mid AND id < ".$_POST['id']." AND status=1 ORDER BY id DESC LIMIT ".$showLimit;
	$database1 = new Database();
	$dbCon1 = $database1->getConnection();
