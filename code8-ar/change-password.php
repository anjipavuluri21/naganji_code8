	...
	<div class="container clearfix">
		...
		<div class="row" id="ele2">
			<div class="col-lg-12 col-md-12">
				<h1 class="text-center fullwidth">يتغيرون <span>كلمه السر</span></h1>
			</div>
					...
					<div class="mycart-sub">	
						<div class="checkout-sub">
							<div class="password-change">
								...
								<div class="change-div"><button class="button" name="submit" type="submit">غير كلمة السر</button></div>
							</div>
						</div>
					</div>	
				</div>
