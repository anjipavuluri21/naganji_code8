				...
				<div class="col-12">
					<div class="topbar">
						<ul class="location-language">
                                                    <li><span class="lbl"> الموقع&nbsp;: &nbsp;</span>
							<select name="location" id="location" class="form-control" style="width: 102px">
							<?php							
							...
							?>
								<option <?php if($location_result['id']==$_SESSION['COUNTRY']){ echo "selected"; } ?> value="<?php echo $location_result['id']; ?>"><?php echo $location_result['titlear'].' '.$location_result['currencycode']; ?></option>
							<?php							
							}						
							?>
							</select>
                                                        ...
                                                        <li><span class="lbl">الإنجليزية&nbsp;: &nbsp;</span><a href="<?php echo base_url_en."index.php";?>" class="language-text"style="color:#fff;"> >اللغة  </a></li>
						...
						<ul class="ecommerce-div">
							<?php if($_SESSION["SESS_CUSTOMER_ID"]!="" && $_SESSION["SESS_CUSTOMER_TYPE"]=="2"){ ?>
								<li><a href="my-account.php" class="signin-link" title="My Account">حسابي</a></li>
								<li><a href="logout.php" class="signin-link" title="My Account">تسجيل الخروج</a></li>
							<?php } else { ?>
								<li><a href="javascript:void(0);" class="signin-link" title="Sign In" data-fancybox="" data-src="#loginModal" data-animation-duration="700">سجيل الدخول</a></a></li>
							<?php } ?>
							<li>
							...
							<?php } else { ?>
                                                                <a data-src="#wishlistlogpop" data-fancybox="" href="javascript:void(0);" class="favourite-linkguest on-addtocart-btn" title="Favourite"><img src="images/favourite-icon.png" alt="Favourite" width="29px;"><span class="link-span">0</span></a>
							<?php } ?>
								<div class="favourite-popup">
									<div class="favourite-popup-sub">
										...
										<a href="wishlist.php" class="button">عرض قائمة الرغبات</a>
									</div>
								</div>
							</li>
							<?php							
				...
				<div class="wsmain">
					<nav class="wsmenu clearfix">
						<ul class="mobile-sub wsmenu-list">
							<li><a href="index.php" class="active"><?php echo $menutitle_res['title1ar']; ?></a></li>
							<li><a href="javascript:void(0);" class="main-link"><?php echo $menutitle_res['title2ar']; ?></a>
										...
										<div class="container clearfix submenu-div">
											...
											<ul class="menu-items five-part">
												...
												<li class="item-bunch">
													...
													<ul>
														<li><a href="collections_newin.php">وصل حديثًا</a></li>
														<?php							
														...
														?>	
															<li><a href="brands.php?id=<?php echo $brandmenu_result['id']; ?>"><?php echo $brandmenu_result['titlear']; ?></a></li>
														<?php } ?>
													</ul>
												</li>
												<?php							
												...
												?>	
												<li class="item-bunch">
													<a href="javascript:void(0)" class="sub-menu-title"><?php echo $colllocation_result['titlear']; ?></a>
													<ul>
														<?php							
														...
														?>	
															<li><a href="products.php?id=<?php echo $subcolocation_result['id']; ?>"><?php echo $subcolocation_result['titlear']; ?></a></li>
														<?php } ?>
													</ul>
												</li>								  
											<?php } ?>
							...
							<li><a href="sales.php"><?php echo $menutitle_res['title3ar']; ?></a></li>
							<li><a href="javascript:void(0);" class="main-link"><?php echo $menutitle_res['title4ar']; ?></a>
								<ul class="wsmenu-submenu collection-menu">
									<li>
										<div class="container clearfix submenu-div">
							...
							<li><a href="javascript:void(0);" class="main-link"><?php echo $menutitle_res['title5ar']; ?></a>
								<ul class="wsmenu-submenu collection-menu">
									<li>
										<div class="container clearfix submenu-div">
											...
											<ul class="menu-items five-part">
												<li class="item-bunch">
													<a href="javascript:void(0)" class="sub-menu-title">New Arrivals</a>
													<ul>								
														<li><a href="womens_newin.php">وصل حديثًا</a></li>
														<?php							
												...
												?>	
												<li class="item-bunch">
													<a href="javascript:void(0)" class="sub-menu-title"><?php echo $wcolllocation_result['titlear']; ?></a>
													<ul>
														<?php							
														...
														?>	
															<li><a href="products.php?id=<?php echo $wsubcolocation_result['id']; ?>"><?php echo $wsubcolocation_result['titlear']; ?></a></li>
														<?php } ?>
													</ul>
												</li>								  
											<?php } ?>
							...
							<li><a href="find-our-store.php"><?php echo $menutitle_res['title6ar']; ?></a></li>
							<li><a href="contact-us.php"><?php echo $menutitle_res['title7ar']; ?></a></li>
						</ul>
					</nav>
				</div>
			</div>
		...
		<div class="container clearfix">
			<div class="row">
				...
				<form name="search" method="post" action="search.php">
					...
					<div class="form-div">
					<input type="text" class="form-control" placeholder="Search Your Product..." name="searchkeyword"><button type="submit" class="button">بحث</button><a href="javascript:void(0);" class="close-search"> </a></div></div>
				</form>	
				</div>
			</div>
		</div>
...
<div id="addtocartpop" class="popup-hidden animated-modal added-cart-model addddccaartt">
	<p class="anim1"><strong>تمت إضافة المنتج إلى عربة التسوق
!!</strong></p>
	<p class="anim2"><a href="javascript:void(0);" onclick="$.fancybox.close();" class="button">OK</a></p>
</div>
<script>
