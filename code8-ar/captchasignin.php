...
$captcha_font = 'fonts/Asap-Regular.ttf';
...
$captcha_image_signin = @imagecreate(
 $captcha_image_width,
...
imagejpeg($captcha_image_signin); //showing the image
imagedestroy($captcha_image_signin); //destroying the image instance
$_SESSION['captchasign'] = $captcha_code;
