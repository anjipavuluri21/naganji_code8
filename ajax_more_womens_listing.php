...
if(isset($_POST["id"]) && !empty($_POST["id"])){
	...
	$prodcount_que = "SELECT COUNT(*) as num_rows from code8_products where menuid=2 AND id < ".$_POST['id']." AND status=1 ORDER BY id DESC";
	...
	$remprodcount_que = "SELECT * from code8_products where menuid=2 AND id < ".$_POST['id']." AND status=1 ORDER BY id DESC LIMIT ".$showLimit;
