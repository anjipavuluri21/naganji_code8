			...
			<div class="row">
				<div class="col-12">
					<div class="banner-contents">
						<h1><?php echo $homepage_res['title']; ?></h1>
						<div class="wow fadeInRight" data-wow-delay="0.85s" data-wow-duration="1.5s">
						<p><?php echo $homepage_res['caption']; ?></p></div>
						<div class="shop-now wow fadeInLeft" data-wow-delay="0.8s" data-wow-duration="1.5s"><a href="<?php echo $homepage_res['shopnowlink']; ?>" class="button">Shop Now</a></div>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-12">
					<div class="views-field-main">
						...
						<div class="view-field-contents">
							<h3><?php echo $homepage_res1['title']; ?></h3>
							<p><?php echo $homepage_res1['caption']; ?></p>
							<div class="read-more"><a href="<?php echo $homepage_res1['shopnowlink']; ?>">Read More</a></div>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="box-main">
							<div class="box-row">
								...
								<div class="box pink-box content-box"><svg id="Accessories" data-name="Accessories" xmlns="http://www.w3.org/2000/svg"><title><?php echo $homepagebody_res['title1']; ?></title><rect/></svg>
									<div class="box-div">
										<h3><?php echo $homepagebody_res['title1']; ?></h3>
										<div class="read-more"><a href="<?php echo $homepagebody_res['link1']; ?>">Shop Now</a></div>
									</div>	
								</div>
							</div>
							<div class="box-row">
								<div class="box purple-box content-box"><svg id="fragrance" data-name="fragrance" xmlns="http://www.w3.org/2000/svg"><title><?php echo $homepagebody_res['title3']; ?></title><rect/></svg>
									<div class="box-div">
										<h3><?php echo $homepagebody_res['title3']; ?></h3>
										<div class="read-more"><a href="<?php echo $homepagebody_res['link3']; ?>">Shop Now</a></div>
									</div>	
								</div>
								<div class="box gold-box content-box"><svg id="Bags" data-name="Bags" xmlns="http://www.w3.org/2000/svg"><title><?php echo $homepagebody_res['title2']; ?></title><rect/></svg>
									<div class="box-div">
										<h3><?php echo $homepagebody_res['title2']; ?></h3>
										<div class="read-more"><a href="<?php echo $homepagebody_res['link2']; ?>">Shop Now</a></div>
									</div>	
								</div>
							</div>	
						</div>
					...
					<div class="col-12">
						<div class="section03-content">
							<div class="section03-box">
								<h3><?php echo $fashionista_res['title']; ?></h3>
								<p><?php echo $fashionista_res['caption']; ?></p>
								<div class="read-more"><a href="<?php echo $fashionista_res['shopnowlink']; ?>">View More</a></div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-12">
							<div class="section03-left">
								<h2><?php echo $trend_res['title']; ?></h2>
							</div>
				...
				<div class="row">
					<div class="col-12">
						<div class="block-gallery">
							<h2><?php echo $getlook_res['title']; ?></h2>
							<?php echo $getlook_res['caption']; ?>
							<div class="read-more"><a href="<?php echo $getlook_res['shopnowlink']; ?>">More</a></div>
						</div>
					</div>
				</div>
			</div>	
...
<section class="news-main">
	<div class="shop-store">
		...
		<div class="view-our-shop"><a href="#storeModal" data-fancybox data-animation-duration="700"><?php echo $footercont_res['title']; ?></a></div>
	</div>
</section>
