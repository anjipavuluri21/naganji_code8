	...
	<div class="container clearfix">
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<h1 class="text-center fullwidth">Code8 <span>Contact</span></h1>
			</div>
			<div class="col-lg-6 col-md-6 contact-column">
				<div class="my-cart-items gold-color-bg">
					...
					<div class="address-review">
						<h3>Address</h3>
						<p><?php echo $contactpage_res['address']; ?></p>
						<h3>Telephone</h3>
				...
				<div class="my-cart-items gold-color-bg">
					...
					<form method="post" name="feedback">
						<div class="profileforma">
							...
							<div class="form-group">
								<label><p style="font-size:16px">Enter Captcha:</strong></label><br/>
							...
							<div class="form-group">
								...
								<p style="font-size:16px">Can't read the image?
								<a style="color:#fff; font-size:16px" href='javascript: refreshCaptcha();'>click here</a>
								to refresh</p>
							</div>
							<div>
